...
function Config(opts) {
  this.baseWorkingDirectory = path.resolve(opts.cwd || process.cwd());
  _.extend(this, {
    appName: 'ndm', // used by rc.
    serviceJsonPath: path.resolve(this.baseWorkingDirectory, 'service.json'),
...
Config.prototype.defaultLogsDirectory = function() {
  return path.resolve(this.baseWorkingDirectory, './logs')
};
